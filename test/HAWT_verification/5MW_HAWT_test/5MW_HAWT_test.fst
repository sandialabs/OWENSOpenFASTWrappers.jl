...
"ifw_primary.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"ad_primary.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
...
true          VTK_fields      - Write mesh fields to VTK data files? (flag) {true/false} [unused if WrVTK=0]
        100   VTK_fps         - Frame rate for VTK output (frames per second){will use closest integer multiple of DT} [used only if WrVTK=2 or WrVTK=3]
