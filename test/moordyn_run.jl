...
for (idx, t) in enumerate(ts[1:end-2])
    for correction = 1:num_corrections+1
        ...
        OWENSOpenFASTWrappers.MD_UpdateStates(t, t+dt, ptfm_pos, ptfm_vel, ptfm_acc)

        OWENSOpenFASTWrappers.MD_CalcOutput(t+dt, ptfm_pos, ptfm_vel, ptfm_acc, forces, line_tensions)
