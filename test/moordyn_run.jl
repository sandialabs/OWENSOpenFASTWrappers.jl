...
md_lib_filename = "/builds/8921-VAWT-TOOLS/OpenFASTWrappers.jl/openfast/build/modules/moordyn/libmoordyn_c_binding" #change this to match your local path of the MoorDyn DLL
